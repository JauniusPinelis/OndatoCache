...
{
    public class MemoryCacheControllerTests : IClassFixture<MemoryCacheApplicationFactory<Startup>>
    {
        private readonly MemoryCacheApplicationFactory<Startup> _factory;
        private readonly Fixture _fixture = new();


        public MemoryCacheControllerTests(MemoryCacheApplicationFactory<Startup> factory)
        {
